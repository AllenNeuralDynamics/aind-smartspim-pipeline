...
wget -O Dockerfile_stitch https://raw.githubusercontent.com/AllenNeuralDynamics/aind-smartspim-stitch/refs/heads/feat-improve-local-docker/environment/Dockerfile_local
